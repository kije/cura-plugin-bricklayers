...
Item
{
    ...
    Item
    {
        ...
        function onHandleDragged()
        {
            ...
            UM.BrickLayersView.setCurrentLayer(upperValue)
            UM.BrickLayersView.setMinimumLayer(lowerValue)
        }
        ...
        function setValue(value)
        {
            ...
            UM.BrickLayersView.setCurrentLayer(value)
            UM.BrickLayersView.setMinimumLayer(value - range)
        }
    ...
    Rectangle
    {
        ...
        function onHandleDragged()
        {
            ...
            UM.BrickLayersView.setCurrentLayer(getValue())
        }
        ...
        SimulationSliderLabel
        {
            ...
            busy: UM.BrickLayersView.busy
            setValue: upperHandle.setValueManually // connect callback functions
            layerHeight: UM.BrickLayersView.currentLayerHeight
        }
    }
    ...
    Rectangle
    {
        ...
        function onHandleDragged()
        {
            ...
            // set the new value after moving the handle position
            UM.BrickLayersView.setMinimumLayer(getValue())
        }
        ...
        function setValue(value)
        {
            ...
            UM.BrickLayersView.setMinimumLayer(value)
        ...
        SimulationSliderLabel
        {
            ...
            layerHeight: UM.BrickLayersView.minimumLayerHeight
        }
    }
}
