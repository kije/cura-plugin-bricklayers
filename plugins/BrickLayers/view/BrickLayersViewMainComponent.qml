...
Item
{
    ...
    visible: UM.BrickLayersView.layerActivity && CuraApplication.platformActivity
    ...
    PathSlider
    {
        ...
        // Custom properties
        handleValue: UM.BrickLayersView.currentPath
        maximumValue: UM.BrickLayersView.numPaths

        // Update values when layer data changes.
        Connections
        {
            target: UM.BrickLayersView
            function onMaxPathsChanged() { pathSlider.setHandleValue(UM.BrickLayersView.currentPath) }
            function onCurrentPathChanged()
            {
                ...
                pathSlider.setHandleValue(UM.BrickLayersView.currentPath)
            }
        }
    ...
    UM.SimpleButton
    {
        ...
        {
            UM.BrickLayersView.setSimulationRunning(false)
        ...
        {
            UM.BrickLayersView.setSimulationRunning(true)
            UM.BrickLayersView.setCurrentPath(UM.BrickLayersView.currentPath)
    ...
    Timer
    {
        ...
        onTriggered:
        {
            ...
            UM.BrickLayersView.advanceTime(advance_time);
    ...
    LayerSlider
    {
        ...
        // Custom properties
        upperValue: UM.BrickLayersView.currentLayer
        lowerValue: UM.BrickLayersView.minimumLayer
        maximumValue: UM.BrickLayersView.numLayers

        // Update values when layer data changes
        Connections
        {
            target: UM.BrickLayersView
            function onMaxLayersChanged() { layerSlider.setUpperValue(UM.BrickLayersView.currentLayer) }
            function onMinimumLayerChanged() { layerSlider.setLowerValue(UM.BrickLayersView.minimumLayer) }
            function onCurrentLayerChanged()
            {
                ...
                layerSlider.setUpperValue(UM.BrickLayersView.currentLayer)
            }
        }
        ...
        Component.onCompleted:
        {
            layerSlider.setLowerValue(UM.BrickLayersView.minimumLayer)
            layerSlider.setUpperValue(UM.BrickLayersView.currentLayer)
        }
    }
}
