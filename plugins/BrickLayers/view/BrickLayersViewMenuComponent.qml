...
Cura.ExpandableComponent
{
    ...
    Connections
    {
        ...
        function onPreferenceChanged(preference)
        {
            ...
            layerTypeCombobox.currentIndex = UM.BrickLayersView.compatibilityMode ? 1 : UM.Preferences.getValue("layerview/layer_view_type")
    ...
    contentItem: Column
    {
        ...
        property bool show_legend: UM.BrickLayersView.compatibilityMode ? true : UM.Preferences.getValue("layerview/layer_view_type") == 1
        property bool show_gradient: UM.BrickLayersView.compatibilityMode ? false : UM.Preferences.getValue("layerview/layer_view_type") == 2 || UM.Preferences.getValue("layerview/layer_view_type") == 3
        ...
        Cura.ComboBox
        {
            ...
            visible: !UM.BrickLayersView.compatibilityMode

            onActivated: (index) => {UM.Preferences.setValue("layerview/layer_view_type", index)}

            Component.onCompleted:
            {
                currentIndex = UM.BrickLayersView.compatibilityMode ? 1 : UM.Preferences.getValue("layerview/layer_view_type");
            ...
            function updateLegends(type_id)
            {
                ...
                viewSettings.show_legend = UM.BrickLayersView.compatibilityMode || (type_id == 1);
                viewSettings.show_gradient = !UM.BrickLayersView.compatibilityMode &&
        ...
        Repeater
        {
            model: ListModel
            {
                ...
                Component.onCompleted:
                {
                    ...
                    if (! UM.BrickLayersView.compatibilityMode)
                    {
                        typesLegendModel.append({
        ...
        Item
        {
            ...
            UM.Label //Minimum value.
            {
                text:
                {
                    if (UM.BrickLayersView.layerActivity && CuraApplication.platformActivity)
                    {
                        // Feedrate selected
                        if (UM.Preferences.getValue("layerview/layer_view_type") == 2)
                        {
                            return parseFloat(UM.BrickLayersView.minFeedrate).toFixed(2)
                        }
                        // Layer thickness selected
                        if (UM.Preferences.getValue("layerview/layer_view_type") == 3)
                        {
                            return parseFloat(UM.BrickLayersView.minThickness).toFixed(2)
                        }
                        // Line width selected
                        if(UM.Preferences.getValue("layerview/layer_view_type") == 4)
                        {
                            return parseFloat(UM.BrickLayersView.minLineWidth).toFixed(2);
                        }
                        // Flow Rate selected
                        if(UM.Preferences.getValue("layerview/layer_view_type") == 5)
                        {
                            return parseFloat(UM.BrickLayersView.minFlowRate).toFixed(2);
                        }
            ...
            UM.Label //Maximum value.
            {
                text: {
                    if (UM.BrickLayersView.layerActivity && CuraApplication.platformActivity)
                    {
                        ...
                        if (UM.Preferences.getValue("layerview/layer_view_type") == 2)
                        {
                            return parseFloat(UM.BrickLayersView.maxFeedrate).toFixed(2)
                        }
                        // Layer thickness selected
                        if (UM.Preferences.getValue("layerview/layer_view_type") == 3)
                        {
                            return parseFloat(UM.BrickLayersView.maxThickness).toFixed(2)
                        }
                        //Line width selected
                        if(UM.Preferences.getValue("layerview/layer_view_type") == 4)
                        {
                            return parseFloat(UM.BrickLayersView.maxLineWidth).toFixed(2);
                        }
                        // Flow rate selected
                        if(UM.Preferences.getValue("layerview/layer_view_type") == 5)
                        {
                            return parseFloat(UM.BrickLayersView.maxFlowRate).toFixed(2);
                        }
                    }
